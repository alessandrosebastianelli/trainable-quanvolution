...
class EuroSATDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_dataset = EuroSATDataset(os.path.join('dataset', 'training'), transform=transform)
        self.valid_dataset = EuroSATDataset(os.path.join('dataset', 'validation'), transform=transform)
